 ...
 * Get column metadata for a data source.
...
export async function GET(
  ...
  try {
    // First verify the data source exists and belongs to the workspace
    ...
    const columns = await dataSourceService.getColumns(id);
